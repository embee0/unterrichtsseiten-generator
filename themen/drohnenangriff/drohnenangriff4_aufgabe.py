...
class Agent:
    ...
    def position(self):
        # TODO: Gib self.x und self.y mit return zurueck.
        ...
...
class Drohne:
    ...
    def abstand(self, ziel_x, ziel_y):
        # TODO: Gib den Abstand zwischen Drohne und Zielpunkt zurueck.
        # Du kannst dafuer die fertige py5-Funktion dist(...) benutzen.
        ...
...
def draw():
    ...
    if not game_over:
        agent.steuern()
        # TODO: Fange die zwei Rueckgabewerte von position()
        # in den Variablen agent_x und agent_y auf.
        ...
        drohne.verfolgen(agent_x, agent_y)

        # TODO: Setze game_over auf True, wenn der Abstand klein genug ist.
        # Nutze dafuer den Rueckgabewert von abstand(...).
        ...
